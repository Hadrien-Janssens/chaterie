        ...
        <div className="m-5 my-10">
          <div className=" text-justify relative m-5">
            ...
            <p>
              ...
              puces/parasites et munis de leur passeport européen au prix de
              900.
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              Nos chatons sont élevés dans l’amour et la bienveillance. C’est
              pour cette raison que nous nous réservons le droit de lui choisir
              la meilleur des familles et nous pourront refuser une adoption si
          ...
          <div className="mt-10 ">
            ...
            <div className="bg-[#51687F] text-white p-5 relative shadow-md">
              ...
              <p>
                Vous prenez contact avec nous afin de vérifier la disponibilité
                du chaton et nous planifions ensuite une visite si vous
                souhaitez le voir. La réservation est validée après le paiement
                d’un acompte de 100 euros.
              </p>
