    ...
    <div className="bg-[#F4F4F4]  p-10 ">
      <div className="flex gap- justify-center">
        ...
        <div className="relative flex flex-col">
          ...
          <p className="font-medium mb-10">né le 05/07/2024</p>
          <Button>Voir plus</Button>

          <div className="absolute w-[40%] h-[40%] border-[#B38D7D] border-t-4 border-r-4 -top-5 -right-5"></div>
          <div className="absolute w-[40%] h-[40%] border-[#B38D7D] border-b-4 border-r-4 -bottom-5 -right-5"></div>
        </div>
      </div>
